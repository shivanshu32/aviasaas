...
const OpdBillPrint = forwardRef(({ bill }, ref) => {
    ...
    <div ref={ref} className="print-document">
      ...
      <div className="patient-section">
        <div className="patient-row">
          ...
          <span className="patient-value">{patient.name || bill.patientName || 'N/A'}</span>
        </div>
        <div className="patient-row">
...
OpdBillPrint.displayName = 'OpdBillPrint';

export default OpdBillPrint;
