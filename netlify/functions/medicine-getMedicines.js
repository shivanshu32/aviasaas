    ...
    const pipeline = [
      ...
      },
      {
        $addFields: {
          ...
          weightedAvgMrp: { $arrayElemAt: ['$stockInfo.weightedAvgMrp', 0] },
          weightedAvgSellingPrice: { $arrayElemAt: ['$stockInfo.weightedAvgSellingPrice', 0] },
          weightedAvgPurchasePrice: { $arrayElemAt: ['$stockInfo.weightedAvgPurchasePrice', 0] },
